...
parser.add_argument("--model", choices=["independent", "independent-single", "dependent", "dependent-single", "fixed"], help="Choose from the available models: Independent mean and std, dependent mean and std and fixed std.")
...
elif config.MODEL == "independent-single":
    from pnetkld.models import IndependentSingleStd as Model
elif config.MODEL == "dependent":
    from pnetkld.models import DependentStd as Model
elif config.MODEL == "dependent-single":
    from pnetkld.models import DependentSingleStd as Model
